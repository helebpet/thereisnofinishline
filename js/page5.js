// Full working p5.js sketch with fixed period and larger typewriter text
...
let sentenceDisplayDuration = 4000;
...
// Replace this block inside createTextElements():
typewriterElement.style('font-weight', '900');
typewriterElement.style('font-size', 'clamp(4rem, 8vw, 6rem)'); // Made larger
typewriterElement.style('line-height', '1.2'); // Reduced line-height for tight text
typewriterElement.style('letter-spacing', '-0.05em'); // Looser to prevent cut-off
typewriterElement.style('word-spacing', '0.15em');
typewriterElement.style('padding', '0.2em 0.4em'); // Added padding around the text
...
typewriterElement.style('overflow', 'visible'); // Prevent clipping
